---
title: "How to use harmony-py to spatially subset ATLAS/ICESat-2 Land-ice Height (ATL06) data"
...
## Problem
How can I spatially subset ATL06 data using the harmony-py Python library?
...
```
Define which data you'd like to access using the collection concept-id (see this [how-to](./how-to-guides/) for retrieving collection concept-ids). For this example, we'll use ATL06 version 007, C3564876127-NSIDC_CPRD.
```python
