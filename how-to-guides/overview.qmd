...
- How to search for data (via [`earthaccess`](https://earthaccess.readthedocs.io/en/stable/user_guide/search/)); 
- How to access data (via [`earthaccess`](https://earthaccess.readthedocs.io/en/stable/user_guide/access/));
- How to customize data using NASA Harmony services (via [`harmony-py`](https://harmony-py.readthedocs.io/en/main/))
