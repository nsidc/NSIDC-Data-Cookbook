...
- How to search for data (via [`earthaccess`](https://earthaccess.readthedocs.io/en/stable/user/search/)); 
- How to access data (via [`earthaccess`](https://earthaccess.readthedocs.io/en/stable/user/access/));
