...
`search_data` queries NASA's Common Metadata Repository (CMR) and returns a list of granule objects for the data set matching the DOI, spatial, and temporal bounds. 
