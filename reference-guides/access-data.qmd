...
By default, `earthaccess.login()` will look for a `.netrc` or environment variables first.  If neither of these are found, it will prompt you to enter your username and password.  The three methods are described in the `earthaccess` documentation [here](https://earthaccess.readthedocs.io/en/stable/user/authenticate/).
