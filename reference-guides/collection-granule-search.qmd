...
Earthaccess has a [Quickstart Guide](https://earthaccess.readthedocs.io/en/stable/user/quick-start/) with instructions for installation as well as more [detailed documentation](https://earthaccess.readthedocs.io/en/stable/user/) on searching for data.
...
77
```
Other parameters accepted by `earthaccess.search_datasets` can be found [here](https://earthaccess.readthedocs.io/en/stable/api/#earthaccess.api.search_datasets).
...
`earthaccess.search_data` allows you to search for specific granules (i.e. files or bundles of files) within a specified collection using filters. Below we'll search for land-ice height data over the Juneau Ice Field in Alaska for a certain time period.
...
Other parameters accepted by `earthaccess.search_datasets` can be found [here](https://earthaccess.readthedocs.io/en/stable/api/#earthaccess.api.search_data) and additional usage examples can be found [here](https://earthaccess.readthedocs.io/en/stable/user/search/#search-for-data-granules-using-search_data).
