...
Other parameters accepted by `earthaccess.search_data` can be found [here](https://earthaccess.readthedocs.io/en/stable/api/#earthaccess.api.search_data) and additional usage examples can be found [here](https://earthaccess.readthedocs.io/en/stable/user/search/#search-for-data-granules-using-search_data).
