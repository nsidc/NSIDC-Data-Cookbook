...
More complete documentation for using `earthaccess` to search for data can be found [here](https://earthaccess.readthedocs.io/en/stable/user_guide/search/).

### [Quickstart Guide](https://earthaccess.readthedocs.io/en/stable/quick-start/) with instructions for installing `earthaccess`.
...
```python
pprint.pprint(files[0].size)
```
```
<bound method DataGranule.size of Collection: {'EntryTitle': 'ATLAS/ICESat-2 L3A Land Ice Height V006'}
