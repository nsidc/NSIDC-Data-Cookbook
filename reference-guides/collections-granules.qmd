...
Each granule *usually* represents a **single point in space and/or time**, though what that means can vary from one science mission (and data product) to the next. For example, one granule could represent:
...
Simply, CMR is a high-performance, continuously evolving metadata system that catalogs all metadata for NASA’s Earth Science Data and Information System Project (ESDIS) program. You can learn more about it [here](https://www.earthdata.nasa.gov/about/esdis/eosdis/cmr).
