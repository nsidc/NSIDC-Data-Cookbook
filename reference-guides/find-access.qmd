...
|`harmony-py` Python library|**Recommended method** - Utilize NASA Harmony services to subset, reformat, reproject certain NASA Earthdata cloud data sets.|[Documentation](https://nasa-openscapes.github.io/earthdata-cloud-cookbook/tutorials/Harmony.html)|
