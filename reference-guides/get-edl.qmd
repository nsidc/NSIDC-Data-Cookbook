...
NASA Earthdata are freely accessible to all users, but a NASA Earthdata Login is required for access.  Users can register for an Earthdata Login at https://urs.earthdata.nasa.gov/.
