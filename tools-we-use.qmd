...
Below we mention various tools that perform different tasks. To help distinguish which tools can perform which tasks, look for the following icons next to them and refer to this table for their meaning:

| task | icon |
| ----- | --- |
| Data Access: | ![data-access](images/data-access.svg){width=5%} |
| Data Visualization: | ![data-visualization](images/data-visualization.svg){width=5%} |
| Data Conversion: | ![data-conversion](images/data-conversion.svg){width=7%} |
| Data Analysis: | ![data-analysis](images/data-analysis.svg){width=5%} |
| Computation Scaling: | ![computation](images/computation.svg){width=5%} |
...
#### earthaccess &nbsp;![data-access](images/data-access.svg){width=2%}

[`earthaccess`](https://earthaccess.readthedocs.io/en/latest/) — search for and access NASA Earth science data.

#### xarray &nbsp;![data-conversion](images/data-conversion.svg){width=3%} ![data-analysis](images/data-analysis.svg){width=2%}

[`xarray`](https://xarray.dev/) — work with N-dimensional labeled data (e.g. `(time, x, y, z)`).

#### rioxarray &nbsp;![data-conversion](images/data-conversion.svg){width=3%} ![data-analysis](images/data-analysis.svg){width=2%}

[`rioxarray`](https://corteva.github.io/rioxarray/stable/index.html) — add geospatial awareness to `xarray`.

#### rasterio &nbsp;![data-conversion](images/data-conversion.svg){width=3%} ![data-analysis](images/data-analysis.svg){width=2%}

[`rasterio`](https://rasterio.readthedocs.io/en/stable/intro.html) — read, write, and process raster datasets.

#### pandas &nbsp;![data-analysis](images/data-analysis.svg){width=2%}

[`pandas`](https://pandas.pydata.org/docs/index.html) — handle tabular data (spreadsheets, databases, CSV).

#### geopandas &nbsp;![data-analysis](images/data-analysis.svg){width=2%}

[`geopandas`](https://geopandas.org/en/stable/) — extend `pandas` to work with geospatial vector data.

#### cartopy &nbsp;![data-visualization](images/data-visualization.svg){width=2%}

[`cartopy`](https://scitools.org.uk/cartopy/docs/latest/) — map projections, transformations, and plotting for geospatial data.

#### sliderule &nbsp;![data-access](images/data-access.svg){width=2%} ![data-visualization](images/data-visualization.svg){width=2%} ![data-analysis](images/data-analysis.svg){width=2%}

[`sliderule`](https://github.com/ICESat2-SlideRule/sliderule-python) — on-demand processing and access to ICESat-2 data.

#### icepyx &nbsp;![data-access](images/data-access.svg){width=2%} ![data-visualization](images/data-visualization.svg){width=2%} ![data-analysis](images/data-analysis.svg){width=2%}

[`icepyx`](https://icepyx.readthedocs.io/en/latest/) — search, subset, and download ICESat-2 data with built-in metadata handling.

#### satpy &nbsp;![data-visualization](images/data-visualization.svg){width=2%} ![data-conversion](images/data-conversion.svg){width=3%}

[`satpy`](https://satpy.readthedocs.io/en/stable/) — read, composite, and visualize meteorological satellite data.

#### dask &nbsp;![computation](images/computation.svg){width=2%}
...
#### Earthdata Search &nbsp;![data-access](images/data-access.svg){width=2%}
...
#### Open Altimetry &nbsp;![data-access](images/data-access.svg){width=2%} ![data-visualization](images/data-visualization.svg){width=2%}
...
#### HDFView &nbsp;![data-visualization](images/data-visualization.svg){width=2%}
...
#### Panoply &nbsp;![data-visualization](images/data-visualization.svg){width=2%}
...
#### NCView &nbsp;![data-visualization](images/data-visualization.svg){width=2%}
...
#### QGIS &nbsp;![data-visualization](images/data-visualization.svg){width=2%} ![data-conversion](images/data-conversion.svg){width=3%} ![data-analysis](images/data-analysis.svg){width=2%}

[`QGIS`](https://qgis.org/) — an open-source geographic information system for analyzing and visualizing spatial data.

#### ArcGIS &nbsp;![data-visualization](images/data-visualization.svg){width=2%} ![data-conversion](images/data-conversion.svg){width=3%} ![data-analysis](images/data-analysis.svg){width=2%}
