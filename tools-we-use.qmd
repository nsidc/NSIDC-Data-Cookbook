...
<br>
 ...
 <!-- ![data-access](images/data-access.svg){width=10%} ![data-visualization](images/data-visualization.svg){width=10%} ![data-conversion](images/data-conversion.svg){width=10%} ![data-analysis](images/data-analysis.svg){width=10%} ![computation](images/computation.svg){width=10%} -->

| Task | Symbol |
| ----- | --- |
| Data access and discovery: | ![data-access](images/data-access.svg){width=30%} |
| Data visualization: | ![data-visualization](images/data-visualization.svg){width=30%} |
| Data reformatting and transformation: | ![data-conversion](images/data-conversion.svg){width=30%} |
| Data analysis: | ![data-analysis](images/data-analysis.svg){width=30%} |
| Computation scaling: | ![computation](images/computation.svg){width=30%} |
...
#### earthaccess &nbsp;![data-access](images/data-access.svg){width=10%}

[`earthaccess`](https://earthaccess.readthedocs.io/en/latest/) — search for and access NASA Earth science data.

#### xarray &nbsp;![data-conversion](images/data-conversion.svg){width=10%} ![data-analysis](images/data-analysis.svg){width=10%}

[`xarray`](https://xarray.dev/) — work with N-dimensional labeled data (e.g. `(time, x, y, z)`).

#### rioxarray &nbsp;![data-conversion](images/data-conversion.svg){width=10%} ![data-analysis](images/data-analysis.svg){width=10%}

[`rioxarray`](https://corteva.github.io/rioxarray/stable/index.html) — add geospatial awareness to `xarray`.

#### rasterio &nbsp;![data-conversion](images/data-conversion.svg){width=10%} ![data-analysis](images/data-analysis.svg){width=10%}

[`rasterio`](https://rasterio.readthedocs.io/en/stable/intro.html) — read, write, and process raster datasets.

#### pandas &nbsp;![data-analysis](images/data-analysis.svg){width=10%}

[`pandas`](https://pandas.pydata.org/docs/index.html) — handle tabular data (spreadsheets, databases, CSV).

#### geopandas &nbsp;![data-analysis](images/data-analysis.svg){width=10%}

[`geopandas`](https://geopandas.org/en/stable/) — extend `pandas` to work with geospatial vector data.

#### cartopy &nbsp;![data-visualization](images/data-visualization.svg){width=10%}

[`cartopy`](https://scitools.org.uk/cartopy/docs/latest/) — map projections, transformations, and plotting for geospatial data.

#### sliderule &nbsp;![data-access](images/data-access.svg){width=10%} ![data-visualization](images/data-visualization.svg){width=10%} ![data-analysis](images/data-analysis.svg){width=10%}

[`sliderule`](https://docs.slideruleearth.io/) — on-demand processing and access to ICESat-2 data.

#### icepyx &nbsp;![data-access](images/data-access.svg){width=10%} ![data-visualization](images/data-visualization.svg){width=10%} ![data-analysis](images/data-analysis.svg){width=10%}

[`icepyx`](https://icepyx.readthedocs.io/en/latest/) — search, subset, and download ICESat-2 data with built-in metadata handling.

#### satpy &nbsp;![data-visualization](images/data-visualization.svg){width=10%} ![data-conversion](images/data-conversion.svg){width=10%}

[`satpy`](https://satpy.readthedocs.io/en/stable/) — read, composite, and visualize meteorological satellite data.

#### dask &nbsp;![computation](images/computation.svg){width=10%}
...
#### Earthdata Search &nbsp;![data-access](images/data-access.svg){width=10%}
...
#### Open Altimetry &nbsp;![data-access](images/data-access.svg){width=10%} ![data-visualization](images/data-visualization.svg){width=10%}

[`Open Altimetry`](https://openaltimetry.earthdatacloud.nasa.gov/data/) — a browser-based tool for visualizing and accessing ICESat and ICESat-2 altimetry data.

#### SlideRule &nbsp;![data-access](images/data-access.svg){width=10%} ![data-visualization](images/data-visualization.svg){width=10%} ![data-analysis](images/data-analysis.svg){width=10%}

[`SlideRule`](https://slideruleearth.io) — web client for on-demand processing and access to ICESat-2 data.

#### HDFView &nbsp;![data-visualization](images/data-visualization.svg){width=10%}

[`HDFView`](https://www.hdfgroup.org/download-hdfview/) — a desktop application for viewing and editing HDF4 and HDF5 files.

#### Panoply &nbsp;![data-visualization](images/data-visualization.svg){width=10%}
...
<!-- #### NCView &nbsp;![data-visualization](images/data-visualization.svg){width=10%}

[`NCView`](https://cirrus.ucsd.edu/ncview/) — a lightweight utility for quickly viewing netCDF files, especially time series of 2D variables. -->


#### QGIS &nbsp;![data-visualization](images/data-visualization.svg){width=10%} ![data-conversion](images/data-conversion.svg){width=10%} ![data-analysis](images/data-analysis.svg){width=10%}

[`QGIS`](https://qgis.org/) — an open-source geographic information system for analyzing and visualizing spatial data.

#### ArcGIS &nbsp;![data-visualization](images/data-visualization.svg){width=10%} ![data-conversion](images/data-conversion.svg){width=10%} ![data-analysis](images/data-analysis.svg){width=10%}
